...
--
-- Table structure for table `sub_option_master`
--

DROP TABLE IF EXISTS `sub_option_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sub_option_master` (
  ...
  KEY `p_id` (`p_id`),
  CONSTRAINT `sub_option_master_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `option_master` (`srno`)
