...
CREATE TABLE `preferences` (
  ...
  `pref_locn` varchar(50) DEFAULT NULL,
  `notice_period` varchar(3) DEFAULT NULL,
  `expected` varchar(10) DEFAULT NULL,
  `current` varchar(10) DEFAULT NULL,
  `dept` varchar(10) DEFAULT NULL,
  `record_status` varchar(1) DEFAULT NULL,
  UNIQUE KEY `srno` (`srno`),
  KEY `uid` (`uid`),
  CONSTRAINT `preferences_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `basic_details` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-04-19 19:14:18
