...
CREATE TABLE `techs` (
  ...
  `tech_name` varchar(5) DEFAULT NULL,
  `tech_status` varchar(3) DEFAULT NULL,
  `record_status` varchar(1) DEFAULT NULL,
  UNIQUE KEY `srno` (`srno`),
  KEY `uid` (`uid`),
  CONSTRAINT `techs_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `basic_details` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
